          ...
          <div class="Date-Sile-Bar">
            ...
            <div class="Today">
              <div class="component-Date">
                <a href="#container-Detail-Subtheater" onclick="chooseDateforquery(0);p=0;">
            ...
            <div class="Today-1">
              <div class="component-Date">
                <a href="#container-Detail-Subtheater" onclick="chooseDateforquery(1)p=1;">
            ...
            <div class="Today-2">
              <div class="component-Date">
                <a href="#container-Detail-Subtheater" onclick="chooseDateforquery(2)p=2;">
            ...
            <div class="Today-3">
              <div class="component-Date">
                <a href="#container-Detail-Subtheater" onclick="chooseDateforquery(3);p=3;">
            ...
            <div class="Today-4">
              <div class="component-Date">
                <a href="#container-Detail-Subtheater" onclick="chooseDateforquery(4);p=4;">
            ...
            <div class="Today-5">
              <div class="component-Date" onclick="chooseDateforquery(5);p=5;">
